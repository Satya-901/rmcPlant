...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Product</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row gy-5 gx-4">
                <?php
                $i = 1;
                $servicesql = $conn->query("SELECT * FROM `product` ORDER BY `product`.`id` DESC");
                while ($servicedata = $servicesql->fetch_assoc()) {
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="<?php echo '0.' . $i++; ?>s">
                        <div class="service-item">
                            ...
                            <a class="btn btn-light" href="./product_details.php?product=<?= $servicedata['id'] ?>">Read
                                More</a>
                        </div>
                    </div>
                    <?php
