...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2024 at 07:54 AM
...
(2, 'Product Name', 'project-1.jpg', '<p>Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product Product&nbsp;</p>\r\n<!--</body--><!--</body-->', '2023-12-22');
...
(1, 'Shri Tirupati Balaji agency', '', 'https://www.instagram.com', 'https://www.facebook.com/', 'https://www.twitter.com', '8299271312', '9838075284', 'info@stba.com', 'support@stba.com', '222N, Basharat East, Medical College Road, Gorakhpor -273004', 'video.mp4');
