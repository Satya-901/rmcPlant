...
if (isset($_POST['updatevision'])) {
    ...
    if ($text1Count > 20) {
        $wordCountmsg1 = "<span class='text-danger'>The text area should not exceed 20 words.</span>";
    } else {
        if ($text2Count > 20) {
            $wordCountmsg2 = "<span class='text-danger'>The text area should not exceed 20 words.</span>";
        } else {
            if ($text3Count > 20) {
                $wordCountmsg3 = "<span class='text-danger'>The text area should not exceed 20 words.</span>";
            } else {
                $visionsql = "UPDATE `vision` SET `heading1`='$heading1',`text1`='$text1',`heading2`='$heading2',`text2`='$text2',`heading3`='$heading3',`text3`='$text3' WHERE id = '1'";
