...
if (isset($_POST['updateservice'])) {
    ...
    if ($wordCount > 30) {
        $wordCountmsg = "<span class='text-danger'>The text area should not exceed 30 words.</span>";
    } else {
        $servicesql = "UPDATE `services` SET `service`='$heading',`image`='$filename',`stext`='$stext',`text`='$text' WHERE id = '" . $_GET['service'] . "'";
...
<div class="card">
    <div class="card-body">
        ...
        <form enctype="multipart/form-data" action="" method="post" class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-md-4">
                <img id="preview" src="../img/<?= $servicedata['image'] ?>" alt="Your Uploaded Image Will Appear Here">
            </div>
            <div class="col-md-12">
                ...
                <Small>
                    <i>
                        <?php if ($wordCountmsg != "") {
                            ...
                            echo "Sort description Must content 30 Words only (It will be displayed on homepage of your website.)";
                        } ?>
                    </i>
                </Small>
