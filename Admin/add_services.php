            ...
            <div class="card-body">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($wordCount > 30) {
                        ...
                        $aboutsql = "INSERT INTO `services`(`service`, `image`, `stext`) VALUES ('$heading','$filename','$stext')";
                        ...
                        <Small>
                            <i>
                                <?php if ($wordCountmsg != "") {
                                    ...
                                    echo "Sort description Must content 20 Words only.";
                                } ?>
                            </i>
                        </Small>
                        ...
                        while ($row = $qry->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="./index.php?page=update_services&id=<?= $row['id'] ?>"
